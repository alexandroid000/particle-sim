...
if __name__ == '__main__':
    ...
    baseline_densities = find_densities("data/oct_baseline.xyz", 1., c_poly, area_c, area_outside)
    print("Analyzing 10% data...")
    ten_percent_densities = find_densities("data/oct_10percent.xyz", 0.9, c_poly, area_c, area_outside)
    print("Analyzing 20% data...")
    twenty_percent_densities = find_densities("data/oct_20percent.xyz", 0.8, c_poly, area_c, area_outside)
